...
<link href="/hj/Public/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="/hj/Public/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" action="" method="post">
		...
		<div class="form-group">
			<img src="/hj/index.php?m=open&c=checkcode&a=index&time=" alt="" title="点击切换" style="cursor:pointer" id="yanzheng">
		</div>
...
<script src="/hj/Public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="/hj/Public/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
